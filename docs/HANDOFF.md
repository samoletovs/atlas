...
> Status: **MVP deployed**. Phases 0–3 shipped + 5 seed lessons. Auth: Microsoft Entra ID (146099412+samoletovs@users.noreply.github.com).
...
Sign in with your Microsoft account (`146099412+samoletovs@users.noreply.github.com`). Google login is not available on Free-tier SWA gen .7 — see [AUTH-GOOGLE.md](AUTH-GOOGLE.md) for the full investigation.
...
2. Tap "Sign in with Microsoft" → use `146099412+samoletovs@users.noreply.github.com`
